...
public class UtilityClass {
    ...
    private static ArrayList<StepsRecorder> stepsRecorderArrayList = new ArrayList<>();


    public static void addStep (String stepNumber, String word, String rule, String transformation) {
        StepsRecorder step= new StepsRecorder(stepNumber,rule, word, transformation);
        stepsRecorderArrayList.add(step);
    }
    public static ArrayList<StepsRecorder> getStepRecorderArrayList() {
        return stepsRecorderArrayList;
    }

    public static void modifyLastTransformation (String transformation) {
        stepsRecorderArrayList.get(stepsRecorderArrayList.size() -1).setTransformation(transformation);
    }

    public static void printAllSteps () {
        for (StepsRecorder st : stepsRecorderArrayList) {
            System.out.println(st);
        }
    }

    public static void cleanStepRecorderArray () {
        stepsRecorderArrayList.clear();
    }
